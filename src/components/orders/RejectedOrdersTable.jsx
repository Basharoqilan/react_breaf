...
const RejectedOrdersTable = () => {
  ...
  // Fetch rejected orders from the Firestore database
  useEffect(() => {
    const fetchOrders = async () => {
      ...
      for (const subscriptionDoc of rejectedSnapshot.docs) {
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-semibold text-gray-100">Rejected Orders</h2>
